...
export const BUILTIN_LUTS: BuiltinLut[] = [
  // Analytic film-stock emulations (generated by scripts/gen-film-luts.mjs).
  { id: 'kodak-2383', name: 'Kodak 2383 Print', file: 'kodak-2383-print.cube' },
  { id: 'fuji-3513', name: 'Fuji 3513 Print', file: 'fuji-3513-print.cube' },
  { id: 'vision3-250d', name: 'Kodak Vision3 250D', file: 'kodak-vision3-250d.cube' },
  { id: 'ilford-hp5', name: 'Ilford HP5 Plus B&W', file: 'ilford-hp5-bw.cube' },
  // Creative looks (Presetpro).
